...
class LandForRentView extends StatefulWidget {
  const LandForRentView({super.key});

  @override
  State<LandForRentView> createState() => _LandForRentViewState();
}

class _LandForRentViewState extends State<LandForRentView> {
  ...
  CatidoryWidget({required CatigoryModel catigory, required onTap}) {
    return Expanded(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: catigory.id == selectedCatigory.id
              ? Colors.blue[800]
              : Colors.white,
          borderRadius: BorderRadius.circular(20),
